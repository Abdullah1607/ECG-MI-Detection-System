"""
Training script — 1-lead CNN at 500 Hz.

Run from project root:
    venv/Scripts/python -m training.train_1lead

Saves best model (lowest val loss) to model/ecg_cnn_1lead.pth
"""
...
MODEL_SAVE = "model/ecg_cnn_1lead.pth"
...
def main():
    ...
    train_ds = ECGDataset(DATA_PATH, split="train", is_12lead=False, augment=True)
    val_ds   = ECGDataset(DATA_PATH, split="val",   is_12lead=False, augment=False)
    ...
    # Class weights — computed from actual train set counts
